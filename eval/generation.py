...
def process_item(item):
    ...
    pattern = r"(<image\d+>|<ref_images_placeholder_list>|<output_images_placeholder_list>)"

    parts = re.split(pattern,  eval_prompt.format(clear_prompt=clear_prompt, task_type=task_type, category=category, checklist=checklist))
...
def main():
    ...
    sub_output_dir = f'{output_dir}/generation_eval'
