...
system_prompt = """
You are an intelligent assistant capable of answering questions in a format that combines text and images (responses include both text and multiple images).

We will provide you with questions, and you need to output answers that include both text and images. The response can contain multiple images.
...
def main():
    ...
    sub_output_dir = f'{output_dir}/interleave'
